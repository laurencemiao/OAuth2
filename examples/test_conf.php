...
define('__OAUTH2_TEST_REDIRECT_URI__','http://localhost/client/cb.php');
define('__OAUTH2_TEST_ENDPOINT_TOKEN__','http://localhost/server/token.php');
define('__OAUTH2_TEST_ENDPOINT_AUTHORIZE__','http://localhost/server/authorize.php');
